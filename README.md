...
#### ■Python（3.11系以降）
動作確認できているのはバージョン3.12〜3.12.6とバージョン3.11.6です（2024年10月9日現在）。  
...
#### ■わんコメ
バージョン5.0.0以降。可能な限り最新のバージョンをご利用ください。（2024年10月9日現在、v6.0.4にて動作確認ができています）。  
...
最新版（v2.0.0以降）をダウンロードして任意の場所に配置してください（v1系はサポート外です）。  
